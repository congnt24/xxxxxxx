...
class ModelHoanThanhData {
    private struct SerializationKeys {
        ...
        static let number_quote = "number_quote"
    }
    ...
    public required init(json: JSON) {
        ...
        number_quote = json[SerializationKeys.number_quote].int
    }
